...
def snapshot(simulation: Simulation) -> tuple[object, ...]:
    ...
    return (
        ...
        herbivore.thirst,
        herbivore.homeostasis.food_integral_s,
        herbivore.homeostasis.water_integral_s,
        herbivore.homeostasis.previous_food_error,
        herbivore.homeostasis.previous_water_error,
